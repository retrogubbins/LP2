...
//vidmem = vga_mem;
    ...
    my_paint(0,32,6,29);
    my_move(0,7);
        my_print("\f6P\f4a\f2l\f3e\f5 SDL - Pi\n\f6Version:"); 
      ...
      //          "PC:%04X IR: %02X AF:%04X HL:%04X\nDE:%04X BC:%04X SP:%04X IX:%04X\nIY:%04X",
            ...
            z80_get_reg(Z80_REG_PC),
                ...
                z80_get_reg(Z80_REG_IY),
                                (unsigned char)bank_latch,
                                (unsigned char)video_latch,disas_bank);
}
